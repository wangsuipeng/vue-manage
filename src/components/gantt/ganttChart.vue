<template>
    <div class="gantt">
        <div id="ndo" style="" class="noprint">
            <!-- This Gantt editor is free thanks to 
            <a href="http://twproject.com" target="_blank">Twproject</a> 
            where it can be used on a complete and flexible project management solution.<br> Get your projects done! Give 
            <a href="http://twproject.com" target="_blank">Twproject a try now</a>. -->
        </div>
...
<script>
    import { jqueryMin } from './libs/jquery.min.js'
    import { jQuery } from './libs/jquery.1.8.js'
    import { jqueryUI } from './libs/jquery-ui.min.js'
    import { jqueryLivequery } from './libs/jquery/jquery.livequery.1.1.1.min.js'
    import { jqueryTimers } from './libs/jquery/jquery.timers.js'
    import { utilities } from './libs/utilities.js'
    import { forms } from './libs/forms.js'
    import { date } from './libs/date.js'
    import { dialogs } from './libs/dialogs.js'
    import { layout } from './libs/layout.js'
    import { i18nJs } from './libs/i18nJs.js'
    import { jqueryDateField } from './libs/jquery/dateField/jquery.dateField.js'
    import { jqueryJST } from './libs/jquery/JST/jquery.JST.js'
    import { jquerySvg } from './libs/jquery/svg/jquery.svg.min.js'
    import { jquerySvgdom } from './libs/jquery/svg/jquery.svgdom.1.8.js'
    import { ganttUtilities } from './ganttUtilities.js'
    import { ganttTask } from './ganttTask.js'
    import { ganttDrawerSVG } from './ganttDrawerSVG.js'
    import { ganttZoom } from './ganttZoom.js'
    import { ganttGridEditor } from './ganttGridEditor.js'
    import { ganttMaster } from './ganttMaster.js'
    import { ganttChart } from './ganttChart.js'
    import { ganttM } from './gantt_m.js'
    export default {
        methods: {
...
<style scoped>
    ...
    @import url('./ganttPrint.css');
    @import url('./platform.css');
    @import url('./libs/jquery/dateField/jquery.dateField.css');
    #ndo{
        position: absolute;
        right: 5px;
        top: 5px;
